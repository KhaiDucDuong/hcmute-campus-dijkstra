...
let addEdge = false;
let cnt = 44; // Start cnt from 4 so dynamic blocks begin after fixed blocks
let dist;
...
var fixedBlocks = [
  ...
  { x: 296, y: 355, label: "2" },
  { x: 464, y: 356, label: "3" },
  { x: 462, y: 401, label: "4", name: "Công viên Khu A" },
  { x: 538, y: 401, label: "5" },
  { x: 540, y: 505, label: "6", name: "Sân vận động đá banh" },
  { x: 597, y: 501, label: "7", name: "Cổng phụ bãi xe Khu A" },
  { x: 595, y: 414, label: "8" },
  { x: 461, y: 561, label: "9" },
  { x: 298, y: 560, label: "10" },
  { x: 460, y: 609, label: "11", name: "Cổng sau Highland" },
  { x: 331, y: 620, label: "12" },
  { x: 300, y: 598, label: "13" },
  { x: 196, y: 566, label: "14" },
  { x: 144, y: 568, label: "15", name: "Sân tập lái khu E" },
  { x: 150, y: 650, label: "16" },
  { x: 463, y: 313, label: "17" },
  { x: 580, y: 602, label: "18", name: "Lối vào gửi bãi xe Khu A" },
  { x: 540, y: 454, label: "19" },
  { x: 464, y: 452, label: "20" },
  { x: 375, y: 504, label: "21", name: "Tòa A - Hội trường" },
  { x: 378, y: 356, label: "22", name: "Khu B" },
  { x: 294, y: 418, label: "23", name: "Tòa D" },
  { x: 195, y: 525, label: "24", name: "Tòa E" },
  { x: 377, y: 563, label: "25", name: "Tòa trung tâm" },
  { x: 462, y: 477, label: "26", name: "Tòa Việt Đức/ Sân vận động Mái Vòm" },
  { x: 349, y: 641, label: "27", name: "Cổng Chính" },
  { x: 295, y: 525, label: "28" },
  { x: 278, y: 525, label: "29", name: "Tạp hóa Thành Đạt" },
  { x: 297, y: 322, label: "30", name: "Tòa C" },
  { x: 461, y: 434, label: "31" },
  { x: 406, y: 434, label: "32", name: "Tòa A - phòng học" },
  { x: 406, y: 355, label: "33" },
  { x: 227, y: 525, label: "34" },
  { x: 228, y: 565, label: "35", name: "Sân bòng chuyền ngoài trời" },
  { x: 414, y: 313, label: "36" },
  { x: 413, y: 291, label: "37", name: "Trạm Y Tế" },
  { x: 414, y: 343, label: "38" },
  ...
  { x: 498, y: 294, label: "44", name: "Cổng phụ gần kí túc xá" },
  { x: 477, y: 271, label: "45" },
  { x: 452, y: 271, label: "46", name: "Kí túc xá" },
];
